import { reactive, hasInjectionContext, getCurrentInstance, toRef, isRef, inject, effectScope, ref, markRaw, watch, isReactive, toRaw, nextTick, computed, getCurrentScope, onScopeDispose, unref, toRefs, version, watchEffect, onServerPrefetch, defineComponent, h, resolveComponent, mergeProps, withCtx, openBlock, createBlock, useSSRContext, withAsyncContext } from "vue";
...
const useCartStore = defineStore("cart", {
  ...
  actions: {
    ...
    increaseQuantity(productId) {
      const index2 = this.items.findIndex((item) => item.product.id === productId);
      if (index2 !== -1) {
        this.items[index2].quantity++;
        sessionStorage.setItem("cart", JSON.stringify(this.items));
      }
    },
    decreaseQuantity(productId) {
      const index2 = this.items.findIndex((item) => item.product.id === productId);
      if (index2 !== -1 && this.items[index2].quantity > 1) {
        this.items[index2].quantity--;
        sessionStorage.setItem("cart", JSON.stringify(this.items));
      }
    },
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "card onmalika-card h-100" }, _attrs))}><div class="onmalika-card-badges"><span class="badge onmalika-card-badges-new" style="${ssrRenderStyle({ "background-color": "#80EE98" })}">new</span><span class="badge onmalika-card-badges-new" style="${ssrRenderStyle({ "background-color": "#FF4A4A" })}">-20%</span></div>`);
      if (!__props.userFav) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(product_info) && unref(product_info).image && unref(product_info).image.url) {
              _push2(`<img${ssrRenderAttr("src", baseurl + unref(product_info).image.url)} class="card-img-top" alt="..." loading="lazy"${_scopeId}>`);
            } else {
            ...
            return [
              unref(product_info) && unref(product_info).image && unref(product_info).image.url ? (openBlock(), createBlock("img", {
                key: 0,
                src: baseurl + unref(product_info).image.url,
                class: "card-img-top",
                alt: "...",
                loading: "lazy"
...
export {
  ...
  useCartStore as b,
  useAuthStore as c,
  useCurrencyStore as d,
  useSeoMeta as e,
  __nuxt_component_0$1 as f,
  useCookie as g,
  useJsonPlaceholderData as h,
  ...
  createPinia as v,
  setActivePinia as w,
  definePayloadReducer as x,
  isNuxtError as y,
  appLayoutTransition as z
};
//# sourceMappingURL=chunk-pg-brands-4e133212.js.map
